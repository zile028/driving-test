...
<section class="container">
    ...
    <article class="d-flex align-items-start ">
        ...
        <form class="flex-grow-1 no-gutters row justify-content-between border rounded-lg p-2"
            action="test_questions.php" method="post" enctype="multipart/form-data">
            ...
            <a class="btn btn-danger mb-0" href="delete.php?action=qimg&id=<?php echo $_GET["id"]; ?>">Ukloni sliku</a>

            <button class=" btn btn-primary" name="save_change" type="submit">Sačuvaj izmene</button>
        </form>
